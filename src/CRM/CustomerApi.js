...
function CustomerApi() {
    ...
    useEffect(() => {
        const getcategory = async () => {
            const res = await fetch("https://truecodeapi.microtechsolutions.co.in/api/CustomerEmployee");
                                    ...
                                    <tbody>
                                        ...
                                        {category.map((getcate, index) => (
                                            <tr key={getcate.Id}>
                                                ...
                                                <button className="btn btn-success mx-2" onClick={() => { UpdateCustomer(getcate.Id) }}> Edit</button>
