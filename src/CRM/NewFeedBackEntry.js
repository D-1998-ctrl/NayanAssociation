                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-12 col-sm-4">
                                                                <div className="form-group local-forms">
                                                                    ...
                                                                    <select value={feedbackfrom} onChange={e => setFeedbackfrom(e.target.value)} className="form-control select">
                                                                        {customers
                                                            ...
                                                            <div className="col-12 col-sm-4">
                                                                <div className="form-group local-forms">
                                                                    ...
                                                                    <select className="form-control select" required value={employeesatisfaction} onChange={e => setEmployeesatisfaction(e.target.value === "true")}>
