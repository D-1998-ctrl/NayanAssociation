...
function EditEmp() {
    ...
    //     axios.get("https://truecodeapi.microtechsolutions.co.in/api/Employee?Id=" +id)
    //     .then(result=>{console.lof(result)
    //         setName(result.data.name)

    //     })
    //     .catch(err => console.log(err))
    //     // const url = "https://truecodeapi.microtechsolutions.co.in/api/Employee?Id=" +id; 
    ...
    //     result = await result.json();
    //     if (result) {
    //         console.warn("user has been deleted");
    //         getAPIData()
    //     }
    // }
    ...
    //     const getcategory= async() =>("https://truecodeapi.microtechsolutions.co.in/api/Employee?Id=" + Id)
    //         .then(result => {
    //             console.log(result)
    ...
    // const Update = (e) => {
    //     e.preventDefault();
    //     axios.put("http://localhost:3001/updateUser/"+id, {name, address, cityId, stateId, addharNo,pan
    // })
    //   .then(result => {
    //     console.log(result);
    //     navigate('/');
