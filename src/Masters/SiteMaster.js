                            ...
                            <>
                                ...
                                <div className="page-wrapper" onSubmit={handlesubmit} >
                                    <div className="content container-fluid" >
                                            ...
                                            <div className="row align-items-center" >
                                                <div className="col-sm-12"  >
                                                    <div className="page-sub-header" >
                                                        <h3 className="page-title" style={{ color: "#00308F", textAlign: 'center' }} >Site Master</h3>
                                        ...
                                        <div className="row" >
                                            <div className="col-sm-12" >
                                                <div className="card comman-shadow" style={{ backgroundColor: '#AFDBF5', color: "#00308F" }}>
                                                            ...
                                                            <div className="row">
                                                                ...
                                                                <div className="col-12 col-sm-4">
                                                                    <div className="form-group local-forms">
                                                                        <label>
                                                                            Site Name <span className="login-danger"></span>
                                                                        </label>
                                                                        <input
                                                                            className="form-control"
                                                                            type="text"
                                                                            placeholder="Enter Site Name"
                                                                            value={sitename} onChange={e => sitenamechange(e.target.value)}
                                                                        />
                                                                    </div>
                                                                </div>
                                                                <div className="col-12 col-sm-4">
                                                                    <div className="form-group local-forms calendar-icon">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value={address1} onChange={e => address1change(e.target.value)}
                                                                        />
                                                                    </div>
                                                                </div>
                                                                <div className="col-12 col-sm-4">
                                                                    <div className="form-group local-forms">
                                                                        <label>Address 2 <span className="login-danger"></span>
                                                                        </label>
                                                                        <input
                                                                            className="form-control"
                                                                            type="text"
                                                                            placeholder="Address 2"
                                                                            value={address2} onChange={e => address2change(e.target.value)}
                                                                        />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className="col-12 col-sm-4">
                                                                    <div className="form-group local-forms">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value={state} onChange={e => statechange(e.target.value)}
                                                                        />
                                                                    </div>
                                                                </div>
                                                                <div className="col-12 col-sm-4">
                                                                    <div className="form-group local-forms">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value={supervisor} onChange={e => supervisorchange(e.target.value)}
                                                                        />
                                                                    </div>
                                                                </div>
                                                                <hr className="my-3" />
